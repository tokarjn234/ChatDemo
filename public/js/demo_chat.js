	...
	function chatHeartbeat(){
		...
		jQuery.ajax({
			url: config.base_url + "index.php/demo_chat/successChat/?action=chatheartbeat",
			cache: false,
			dataType: "json",
	...
	function closeChatBox(chatboxtitle) {
		...
		jQuery.post(config.base_url + "index.php/demo_chat/successChat/?action=closechat", { chatbox: chatboxtitle} , function(data){	
		});
	...
	function checkChatBoxInputKey(event,chatboxtextarea,chatboxtitle) {
		...
		if(event.keyCode == 13 && event.shiftKey == 0)  {
			...
			if (message != '') {
				jQuery.post(config.base_url + "index.php/demo_chat/successChat/?action=sendchat", {to: chatboxtitle, message: message} , function(data){
	...
	function startChatSession(){  
		jQuery.ajax({
			url: config.base_url + "index.php/demo_chat/successChat/?action=startchatsession",
			cache: false,
			dataType: "json",
			success: function(data) {
